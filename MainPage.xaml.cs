    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void EndTheGame()
        {
            if (!playArea.Children.Contains(gameoverText))
            {
                ...
                targetTimer.Stop();
                humanCaptured = false;
                startButton.Visibility = Visibility.Visible;         //making the start button Visible;
        ...
        private void StartGame()
        {
            ...
            humanCaptured = false;
            progressBar.Value = 0;
            startButton.Visibility = Visibility.Collapsed;                  // make the start button invisible during the game; 
        ...
        private void AnimateEnemy(ContentControl enemy, double from, double to, string propertyToAnimate)
        {
            ...
            //Storyboard.SetTargetName(animation, propertyToAnimate);
